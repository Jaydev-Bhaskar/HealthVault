// Demo data for when backend is not connected — matches web version exactly
...
bool isDemoUser(Map<String, dynamic>? user) {
...
final List<Map<String, dynamic>> demoRecords = [
  {
    ...
    'aiParsedData': {
      ...
      'summary':
          'Patient shows improvement. Continue current medication and monitor.',
    },
  },
  {
    '_id': '2',
    ...
    'aiParsedData': {
      ...
      'summary':
          'All parameters within normal range. Cholesterol showing downward trend.',
    },
  },
  {
    '_id': '3',
  ...
  },
  {
    ...
    'aiParsedData': {
      'summary':
          'COVID-19 booster administered. Certificate verified via CoWIN.',
    },
  },
];

final List<Map<String, dynamic>> demoPermissions = [
  {
    '_id': 'p1',
    'doctorName': 'Dr. Rohit Sharma',
  ...
  {
    '_id': 'p3',
    'doctorName': 'Dr. Aman Kulkarni',
    'doctorSpecialty': 'Cardiologist',
    'hospital': 'Ruby Hall, Pune',
    'isActive': false,
    'accessType': 'limited',
...
final List<Map<String, dynamic>> demoFamilyMembers = [
  {
    '_id': 'f1',
    'name': 'Priya Sharma',
    'healthId': 'HV-K8N2P5QL',
    'bloodGroup': 'A+',
    'age': 26,
    'healthScore': 780,
    'riskLevel': 'LOW',
...
final List<Map<String, dynamic>> demoInsights = [
  {
    ...
    'message':
        'Your BP has been consistently normal for the last 3 months. Great job!',
  },
  {
    'id': 2,
    'type': 'warning',
    ...
    'message':
        'Total cholesterol is at 195 mg/dL. Consider reducing saturated fat intake.',
  },
  {
    'id': 3,
    'type': 'positive',
    ...
    'message':
        'You have maintained 95% adherence to your Montelukast schedule.',
  },
  {
    'id': 4,
    'type': 'info',
    ...
    'message':
        'Your annual flu shot is due next month. Schedule with your physician.',
  },
];

final List<Map<String, dynamic>> demoHealthTrends = [
...
final Map<String, dynamic> demoBlockchain = {
  'stats': {
    'totalBlocks': 8,
    'yourTransactions': 7,
    'latestBlockIndex': 7,
    'latestBlockHash':
        '00a3f7c8d2e5b19084f6a2c73d5e8b01f4a7c9d2e6b3f1084a7c5d9e2b6f3a18',
  },
  'ledger': [
    {
      '_id': 'b7',
      ...
      'details': 'Batch medicines added: Montelukast 10mg, Cetirizine 5mg',
      'hash':
          '00a3f7c8d2e5b19084f6a2c73d5e8b01f4a7c9d2e6b3f1084a7c5d9e2b6f3a18',
      'previousHash': '006b2c9d4e7f1a38054c6d8e2b5f7a19083c5d7e9a2b4f6108',
    },
    {
      '_id': 'b6',
      'index': 6,
      ...
      'details': 'Record uploaded: Dr. Sharma Prescription (prescription)',
      'hash': '006b2c9d4e7f1a38054c6d8e2b5f7a19083c5d7e9a2b4f6108',
      'previousHash':
          '00d4e6f8a1b3c5072d4e6f8a1b3c50729e1a3c5d7f90b2d4e6',
    },
    {
      '_id': 'b5',
      'index': 5,
      ...
      'details': 'Access suspended for Dr. Aman Kulkarni (DR-K7M2)',
      'hash':
          '00d4e6f8a1b3c5072d4e6f8a1b3c50729e1a3c5d7f90b2d4e6',
      'previousHash': '00f1a3c5d7e9b20483f5a7c9d1e3b50627d9e',
    },
    {
      '_id': 'b4',
      'index': 4,
      ...
      'hash': '00f1a3c5d7e9b20483f5a7c9d1e3b50627d9e',
      'previousHash': '00c8d0e2f4a6b8173c5d7e9f1a3b5072',
    },
    {
      '_id': 'b3',
      'index': 3,
      ...
      'details':
          'Patient granted limited access to Dr. Priya Desai (DR-PD91)',
      'hash': '00c8d0e2f4a6b8173c5d7e9f1a3b5072',
      'previousHash': '009a1b3c5d7e9f20463b5d7e9f1a3c50',
    },
    {
      '_id': 'b0',
      'index': 0,
